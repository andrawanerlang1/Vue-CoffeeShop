  ...
  actions: {
    createHistory(context, payload) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .post(`https://${process.env.VUE_APP_URL}/history`, payload)
          .then((response) => {
    ...
    createHistoryDetail(context, payload) {
      ...
      return new Promise((resolve, reject) => {
        ...
        console.log(setData);
        axios
          .post(`https://${process.env.VUE_APP_URL}/historydetail`, setData)
          .then((response) => {
            resolve(response);
          })
          .catch((error) => {
    ...
    getHistoryAcc(context, payload) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .get(`https://${process.env.VUE_APP_URL}/history?user_id=${payload}`)
          .then((response) => {
    ...
    getHistoryDetail(context, payload) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .get(
            `https://${process.env.VUE_APP_URL}/historydetail?history_id=${payload}`
          )
          .then((response) => {
    ...
    deleteHistorys(context, payload) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .delete(`https://${process.env.VUE_APP_URL}/history?id=${payload}`)
          .then((response) => {
            resolve(response);
          })
          .catch((error) => {
